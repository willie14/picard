...
public class CramCompatibilityTest {
    ...
    private static final String CRAM_FILE_2 = CramData.TEST_DIR_NAME + "test_cram_file_header_only.cram";
    private static final String CRAM_FILE_ONE_PAIR_MC = CramData.TEST_DIR_NAME + "MarkDuplicates/one_pair_mc.cram";

    private static final String CRAM_FILE_QUERY_SORTED_UNMAPPED = CramData.TEST_DIR_NAME + "unmapped_queryname_sorted.cram";
    private static final String CRAM_FILE_QUERY_SORTED = CramData.TEST_DIR_NAME + "test_cram_file_query_sorted.cram";

    private static final String FASTQ_FILE = CramData.TEST_DIR_NAME + "fastq2bam/fastq-sanger/5k-v1-Rhodobacter_LW1.sam.fastq";

    private static final String CRAM_UNMAPPED = CramData.TEST_DIR_NAME + "SamFileConverterTest/unmapped.cram";
    private static final String CRAM_UNMAPPED_WITH_OQ_TAG = CramData.TEST_DIR_NAME + "unmapped_with_oq_tag.cram";

    private static final String CRAM_UNMAPPED_PART_1 = CramData.TEST_DIR_NAME + "unmapped_part_1.cram";
    private static final String CRAM_UNMAPPED_PART_2 = CramData.TEST_DIR_NAME + "unmapped_part_2.cram";

    private static final String CRAM_SPLIT_UNMAPPED = CramData.TEST_DIR_NAME + "split_test_unmapped.cram";

    private static final String MBA_ALIGNED_CRAM = CramData.TEST_DIR_NAME + "MergeBamAlignment/cliptest.aligned.cram";
    private static final String MBA_UNMAPPED_CRAM = CramData.TEST_DIR_NAME + "MergeBamAlignment/cliptest.unmapped.cram";
    private static final String MBA_REFERENCE = CramData.TEST_DIR_NAME + "MergeBamAlignment/cliptest.fasta";
    ...
    public Object[][] getArgsForCRAMWithReference() {
        return new Object[][] {
                ...
                {"picard.sam.CleanSam", null, CramData.CRAM_FILE, CramData.REFERENCE_FILE},
                {"picard.sam.DownsampleSam", null, CramData.CRAM_FILE, CramData.REFERENCE_FILE},
                {"picard.sam.FixMateInformation", null, CramData.CRAM_FILE, CramData.REFERENCE_FILE},
                {"picard.sam.markduplicates.MarkDuplicates",
                        "M=" + createTempFile("MarkDuplicates", ".dir").getAbsolutePath(),
                        CramData.CRAM_FILE,
                        CramData.REFERENCE_FILE
                },
                {"picard.sam.MergeSamFiles", null, CramData.CRAM_FILE, CramData.REFERENCE_FILE},
                {"picard.sam.PositionBasedDownsampleSam", "FRACTION=0.5", CramData.CRAM_FILE, CramData.REFERENCE_FILE},
                {"picard.sam.SortSam", "SORT_ORDER=queryname", CramData.CRAM_FILE, CramData.REFERENCE_FILE},
                {"picard.sam.ReplaceSamHeader", "HEADER=" + CRAM_FILE_2, CramData.CRAM_FILE, CramData.REFERENCE_FILE},
                {"picard.sam.RevertOriginalBaseQualitiesAndAddMateCigar", null, CRAM_FILE_QUERY_SORTED, CramData.REFERENCE_FILE},
                ...
                {"picard.sam.SetNmMdAndUqTags", null, CramData.CRAM_FILE, CramData.REFERENCE_FILE},
                ...
                {"picard.sam.SplitSamByLibrary", null, CramData.CRAM_FILE, CramData.REFERENCE_FILE}
        };
    }
    ...
    public Object[][] getArgsForCRAMWithoutReferenceToFail() {
        return new Object[][] {
                ...
                {"picard.sam.CleanSam", null, CramData.CRAM_FILE},
                {"picard.sam.DownsampleSam", null, CramData.CRAM_FILE},
                {"picard.sam.FixMateInformation", null, CramData.CRAM_FILE},
                {"picard.sam.markduplicates.MarkDuplicates",
                        "M=" + createTempFile("MarkDuplicates", ".dir").getAbsolutePath(),
                        CramData.CRAM_FILE
                },
                {"picard.sam.MergeSamFiles", null, CramData.CRAM_FILE},
                {"picard.sam.PositionBasedDownsampleSam", "FRACTION=0.5", CramData.CRAM_FILE},
                {"picard.sam.SortSam", "SORT_ORDER=queryname", CramData.CRAM_FILE},
                {"picard.sam.ReplaceSamHeader", "HEADER=" + CRAM_FILE_2, CramData.CRAM_FILE},
                ...
                {"picard.sam.SplitSamByLibrary", null, CramData.CRAM_FILE}
        };
    }
